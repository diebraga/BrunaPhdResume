...
export default function ResearchExp() {
  return (
      <div className="section-content">
        ...
        <br/>
        TITLE: EXPLORING APPROACHES TO TEACHING OF POETRY IN TRANSITION YEAR
        <br/>
        ...
        <br/><br/><br/>
        <strong>RESEARCH STRAND COORDINATOR – PROFESSIONAL MASTER OF EDUCATION</strong>
        <br/><strong className='mr-5'>University of Limerick, Ireland</strong>&nbsp; - &nbsp;<strong className='ml-5'>(Aug 19 – Mar 20)</strong>
        <br/>
        ...
        <br/><br/><br/>
        <strong>RESEARCH ASSISTANT</strong>
        <br/><strong className='mr-5'>University of Limerick, Ireland</strong>&nbsp; - &nbsp;<strong className='ml-5'>(Nov 18)</strong>
        <br/>
        TITLE: THE EVALUATION OF ICT AND PROFESSIONALISM DURING SCHOOL PLACEMENT
        <br/>
        ...
        <br/><br/><br/>
        <strong>GOVERNANCE RESEARCH ASSOCIATE</strong>
        <br/><strong className='mr-5'>Glass Lewis – Limerick, Ireland </strong>&nbsp; - &nbsp;<strong className='ml-5'>(Feb 18 – May 18; Feb 17 – Apr 17)</strong>
        <br/>
        Developed qualitative and quantitative research on corporative governance and executive compensation of European and South American public companies. Had the support of a team but worked mostly independently to write detailed reports/ proxy papers respecting tight deadlines. 
        <br/><br/><br/>
        <strong>RESEARCHER</strong>
        <br/><strong className='mr-5'>Pontifícia Univ. Católica de SP (PUC-SP) – São Paulo, Brazil</strong>&nbsp; - &nbsp;<strong className='ml-5'>(Jan 14 – Jun 16)</strong>
        <br/>
